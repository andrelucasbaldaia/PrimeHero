*** Settings ***
Documentation       Aqui neste arquivo estarão presentes os cenários e keywords que dizem respeito a automação mobile
...
#identificar endereço do celular no terminal "adb devices"  